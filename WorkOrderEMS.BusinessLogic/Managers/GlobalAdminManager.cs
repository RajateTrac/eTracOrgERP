    ...
    public class GlobalAdminManager : IGlobalAdmin
    {
        ...
        public LocationMasterModel GetLocationDetailsByLocationId(long locationId)
        {
            ...
            try
            {
                ...
                ObjLocationMasterModel.ContractDetailsModel = new ContractDetailsModel();
                ...
                //This is for contract Details
                ObjLocationMasterModel.ContractDetailsModel.AdditonalYears = ss.AdditionalYears;
                ObjLocationMasterModel.ContractDetailsModel.ClientInvoicingTerm = ss.ClientInvoicingTerm;
                ObjLocationMasterModel.ContractDetailsModel.ContractEndDate = ss.ContractEndDate;
                ObjLocationMasterModel.ContractDetailsModel.ContractHolder = ss.ContractHolder;
                ObjLocationMasterModel.ContractDetailsModel.ContractStartDate = ss.ContractStartDate;
                ObjLocationMasterModel.ContractDetailsModel.ContractTerms = ss.ContractTerm;
                ObjLocationMasterModel.ContractDetailsModel.ContractType = ss.ContractType;
                ObjLocationMasterModel.ContractDetailsModel.IntercompanyInvoicing = ss.InterCompanyInvoicing;
                ObjLocationMasterModel.ContractDetailsModel.IntercompanyMgmFee = ss.InterCompanyMgmFee;
                ObjLocationMasterModel.ContractDetailsModel.OperatingHolder = ss.OperatingCompany;
                ObjLocationMasterModel.ContractDetailsModel.ReportingDate = ss.ReportingDate;
                ObjLocationMasterModel.ContractDetailsModel.ReportingType = ss.ReportingType;
                ObjLocationMasterModel.ContractDetailsModel.Years = ss.Years;
                ...
                if (CheckDuplicateLocation(objLocation.LocationName.Trim(), objLocation.LocationId, out ObjQrc))
                {
                    ...
                    using (TransactionScope TransScope = new TransactionScope())
                    {
                        if (objLocation.LocationId == 0)
                        {
                            ...
                            ObjLocationMaster.ClientInvoicingTerm = objLocation.ContractDetailsModel.ClientInvoicingTerm;
                            ObjLocationMaster.ContractEndDate = objLocation.ContractDetailsModel.ContractEndDate;
                            ObjLocationMaster.ContractHolder = objLocation.ContractDetailsModel.ContractHolder;
                            ObjLocationMaster.ContractStartDate = objLocation.ContractDetailsModel.ContractStartDate;
                            ObjLocationMaster.ContractTerm = objLocation.ContractDetailsModel.ContractTerms;
                            ObjLocationMaster.ContractType = objLocation.ContractDetailsModel.ContractType;
                            ObjLocationMaster.InterCompanyInvoicing = objLocation.ContractDetailsModel.IntercompanyInvoicing;
                            ObjLocationMaster.InterCompanyMgmFee = objLocation.ContractDetailsModel.IntercompanyMgmFee;
                            //ObjLocationMaster.OperatingCompany = objLocation.ContractDetailsModel.OperatingHolder;
                            ObjLocationMaster.ReportingDate = objLocation.ContractDetailsModel.ReportingDate;
                            ObjLocationMaster.ReportingType = objLocation.ContractDetailsModel.ReportingType;
                            ObjLocationMaster.AdditionalYears = objLocation.ContractDetailsModel.AdditonalYears;
                            ObjLocationMaster.Years = objLocation.ContractDetailsModel.Years;
                            ObjLocationMaster.QuickBookLocId = objLocation.QuickBookLocationId;
                            ...
                            if (ObjLocationMaster.LocationId > 0)
                            {
                                ...
                                //objLocation.ManagerModel.Administrator = 0;
                                ...
                                //Added By Bhushan Dod on 07/06/2016 for bydefault setting when location created according to loc services.
                                SaveByDefaultWidgetSetting(ObjLocationMaster.LocationId, objLocation.ServicesID, 0); //, objLocation.ManagerModel.Administrator
                                #endregion
        ...
        public void UpdateLocation(LocationMasterModel objLocationMasterModel, out QRCModel qrcDetail)
        {
            try
            {
                ...
                if (data != null)
                {
                    ...
                    data.ClientInvoicingTerm = objLocationMasterModel.ContractDetailsModel.ClientInvoicingTerm;
                    data.ContractEndDate = objLocationMasterModel.ContractDetailsModel.ContractEndDate;
                    data.ContractHolder = objLocationMasterModel.ContractDetailsModel.ContractHolder;
                    data.ContractStartDate = objLocationMasterModel.ContractDetailsModel.ContractStartDate;
                    data.ContractTerm = objLocationMasterModel.ContractDetailsModel.ContractTerms;
                    data.ContractType = objLocationMasterModel.ContractDetailsModel.ContractType;
                    data.InterCompanyInvoicing = objLocationMasterModel.ContractDetailsModel.IntercompanyInvoicing;
                    data.InterCompanyMgmFee = objLocationMasterModel.ContractDetailsModel.IntercompanyMgmFee;
                    data.OperatingCompany = objLocationMasterModel.ContractDetailsModel.OperatingHolder;
                    data.ReportingDate = objLocationMasterModel.ContractDetailsModel.ReportingDate;
                    data.ReportingType = objLocationMasterModel.ContractDetailsModel.ReportingType;
                    data.AdditionalYears = objLocationMasterModel.ContractDetailsModel.AdditonalYears;
                    data.Years = objLocationMasterModel.ContractDetailsModel.Years;
                    objLocationRepository.SaveChanges();
                }
                #endregion
        ...
        /// <param name="_AdminUserId"></param>
        /// <param name="IsDelete"></param>
        public List<UserModel> GetLocationEmployeeWO(long locationId)
        {
            EmployeeLocationMappingRepository objEmployeeLocationMappingRepository = new EmployeeLocationMappingRepository();
            ...
            try
            {
                ...
                //    Text = r.FirstName + " " + r.LastName
                //}).ToList();
                return objEmployeeLocationMappingRepository.GetEmployeeByLocation(locationId).Select(r => new UserModel()
                {
                    //Value = Convert.ToString(r.UserId, CultureInfo.InvariantCulture),
                    //Text = r.FirstName.ToTitleCase() + " " + r.LastName.ToTitleCase()
                    ...
                    ProfileImageFile = r.ProfileImageFile == null ? "" : HostingPrefix + ProfileImagePath.Replace("~", "") + r.ProfileImageFile
                }).ToList();
            }
            catch (Exception)
            {
        ...
        public List<WorkRequestAssignmentModelList> GetAllWorkRequestAssignment(long? workRequestAssignmentId, long? requestedBy, string operationName, int? pageIndex, int? numberOfRows, string sortColumnName, string sortOrderBy, string textSearch, long LocationID, long UserID, DateTime StartDate, DateTime EndDate, string filter, string filterqrc, ObjectParameter totalRecords)
        {
            WorkRequestAssignmentRepository _WorkRequestAssignmentRepository = new WorkRequestAssignmentRepository();
            try
            {

                return _WorkRequestAssignmentRepository.GetAllWorkRequestAssignment(workRequestAssignmentId, requestedBy, operationName, pageIndex, numberOfRows, sortColumnName, sortOrderBy, textSearch, LocationID, UserID, StartDate, EndDate, filter, filterqrc, totalRecords);
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <CreatedBy>Bhushan Dod</CreatedBy>
        /// <CreatedDate>2018-02-05</CreatedDate>
        /// <returns></returns>
        public List<GlobalUserModel> GetApplicationAdminDomain()
        {
            try
            {
                GlobalAdminRepository obj_GlobalAdminRepository = new GlobalAdminRepository();
                return obj_GlobalAdminRepository.GetApplicationAdminList();
            }
            catch (Exception ex)
            {
                Exception_B.Exception_B.exceptionHandel_Runtime(ex, "List<GlobalUserModel> GetApplicationAdminDomain()", "Exception While fetching admin list", 0);
                throw ex;
            }
        }
            ...
            using (workorderEMSEntities Context = new workorderEMSEntities())
            {
                try
                {
                    ...
                    if (obj.WorkRequestProjectType == 279)
                    {
                        ...
                        {
                            PushNotificationFCM.FCMAndroid("Continuous Request", lst.DeviceId, objEmailHelper);
                    ...
                    if (obj.WorkRequestProjectType == 128)
                    {
                        ...
                        if (lst.DeviceId != null)
                        {
                            PushNotificationFCM.FCMAndroid("New work order " + obj.WorkOrderCode + " assigned to you at " + lst.LocationName, lst.DeviceId, objEmailHelper);
                    ...
                    if (obj.WorkRequestProjectType == 129)
                    {
                        ...
                        if (lst.DeviceId != null)
                        {
                            PushNotificationFCM.FCMAndroid("Special work order " + obj.WorkOrderCode + " assigned to you at " + lst.LocationName, lst.DeviceId, objEmailHelper);
        ...
        public List<ContractDropdownDetailsModel> ListContractType()
        {
            var _workorderems = new workorderEMSEntities();
            var lstCotractType = _workorderems.ContractTypes.Where(x => x.CTT_IsActive == "Y").Select(x => new ContractDropdownDetailsModel()
            {
                ContractTypeId = x.CTT_Id,
                ContractType = x.CTT_ContractType
            }).ToList();
            return lstCotractType;
        }
        public List<ContractDropdownDetailsModel> ListCompanyHolder(bool status)
        {
            var _workorderems = new workorderEMSEntities();
            var lstCompanyHolder = new List<ContractDropdownDetailsModel>();
            if (status == false)
            {
        ...
        public List<ContractDropdownDetailsModel> ListClientInvoicingTerm()
        {
            var _workorderems = new workorderEMSEntities();
            var lstCompanyHolder = _workorderems.PaymentTerms.Where(x => x.PTM_IsActive == "Y").Select(x => new ContractDropdownDetailsModel()
            {
                ClientInvoicingId = x.PTM_Id,
                ClientInvoicingName = x.PTM_Term
            }).ToList();
            return lstCompanyHolder;
        }
            ...
            try
            {
                ...
                var myOpenings = (from x in Context.spGetMyOpening(PostingId)
                                  select new MyOpeningModel
                                  {
                                      ...
                                      DesireSalary = x.API_DesireSalaryWages,
                                      IsActive = "Y"
                                  }
                                ).ToList();
                return myOpenings;
                    ...
                    var myOpenings = (from x in Context.spGetApplicantInfoForMyInterview(empid)//Where(x => x.APT_Status == "InterviewSchedule")
                                      select new MyOpeningModel
                                      {
                                         ...
                                         // LastName = x.API_LastName,
                                          ...
                                          JobTitle = x.JBT_JobTitle,
                                          ApplicantId = x.APT_ApplicantId,
                                          //JobTitleId = x.id == null ? 0 : x.API_JobTitleID
                                      }
                                    ).ToList();
                    return myOpenings;
                }
        ...
        public List<spGetApplicantInfo_Result> GetApplicantInfo(long userId)
        {
            ...
            try
            {
                using (workorderEMSEntities context = new workorderEMSEntities())
                {
                    var employeeId = context.UserRegistrations.Where(x => x.UserId == userId)?.FirstOrDefault().EmployeeID;
                    return ObjnewAdminRepository.GetApplicantInfo(employeeId);
                }
            }
            catch (Exception ex)
            { throw; }
        ...
        public bool SaveApplicantInfo(OnboardingDetailRequestModel onboardingDetailRequestModel)
        {
            ...
            try
            {
                using (workorderEMSEntities Context = new workorderEMSEntities())
                {
                    ...
                    long mob = 0;
                    long.TryParse(onboardingDetailRequestModel.MobileNumber, out mob);
                    var EMPAction = isEmployeeExists ? "U" : "I";
                    var result = Context.spSetEmployee(EMPAction, null, onboardingDetailRequestModel.EmpId, onboardingDetailRequestModel.App_Id,
                                                onboardingDetailRequestModel.FirstName, onboardingDetailRequestModel.MiddleName, onboardingDetailRequestModel.LastName, onboardingDetailRequestModel.EmailId, mob
                                                , null, null, null, null, null, null, onboardingDetailRequestModel.API_JobTitleID, null, onboardingDetailRequestModel.API_DateOfJoining,
                                                null, onboardingDetailRequestModel.CreatedBy, DateTime.Now, "1", Convert.ToInt16(UserType.GuestUser), string.Format("{0} {1}", onboardingDetailRequestModel.StreetAddress1, onboardingDetailRequestModel.StreetAddress2),
                                                onboardingDetailRequestModel.City, onboardingDetailRequestModel.State, null, null).ToList();
                    ...
                    if (result.Any())
                    {
                        ...
                        var userData = Context.spGetEmployeePersonalInfo(details.EmployeeID).FirstOrDefault();
                        if (userData != null)
                        {
                            bool IsSent = false;
                            var objEmailHelper = new EmailHelper();
                            objEmailHelper.emailid = userData.EMP_Email;
                            objEmailHelper.UserName = details.EmployeeID;
                            objEmailHelper.Password = details.Password;
                            ...
                            objEmailHelper.MailType = "EMPLOYEEHIRED";
                            objEmailHelper.SentBy = onboardingDetailRequestModel.CreatedBy;
                            ...
                            if (IsSent == true)
                            {
                                ...
                                try
                                {
                                    objEmailog.CreatedBy = onboardingDetailRequestModel.CreatedBy;
                                    objEmailog.CreatedDate = DateTime.UtcNow;
                                    objEmailog.DeletedBy = null;
                                    objEmailog.DeletedOn = null;
                                    ...
                                    objEmailog.ModifiedBy = null;
                                    objEmailog.ModifiedOn = null;
                                    objEmailog.SentBy = onboardingDetailRequestModel.CreatedBy;
        ...
        public InterviewersViewModel GetInterviewersList(long applicantId, long userId)
        {
            InterviewersViewModel interviewersList = new InterviewersViewModel();
            try
            {
                using (workorderEMSEntities context = new workorderEMSEntities())
                {
                    ...
                    {
                        INS_API_ApplicantId = x.INS_API_ApplicantId,
                        INS_AvailableTime = x.INS_AvailableTime,
                        INS_Comments = x.INS_Comments,
                        INS_EMP_InterviewerEmployeeId = x.INS_EMP_InterviewerEmployeeId,
        ...
        //public List<spGetQuestionsForInterview_Result4> GetInterviewQuestions(string isExempt)
        {
            ...
            try
            {
                ...
                //Will change this , got some error while directly adding select using Lambda
               var tt = context.InterviewQuestionMasters.ToList();//
                lst = tt.Where(x => x.IQM_Exempt == isExempt).Select(x => new InterviewQuestionMaster()//("Y", "M", null).ToList();//.Select(x => new InterviewQuestionMaster()
                {
        ...
        public List<ChildrenQuestionModel> GetInterviewChildQuestions(int num)
        {
            try
            {
                ...
                using (workorderEMSEntities context = new workorderEMSEntities())
                {
                    ...
                    //}).ToList();
                    //Will change this , got some error while directly adding select using Lambda
                    var get = context.InterviewQuestionChilds.ToList();
                    lst = get.Where(x => x.IQC_IQM_Id == num && x.IQC_IsActive == "Y").
                       Select(x => new ChildrenQuestionModel()
                       {
                           IQM_Id = x.IQC_Id,
        ...
        public bool saveSelfAssessment(List<GWCQUestionModel> data, string action, string UserName)
        {
        ...
        public bool saveEvaluation(List<GWCQUestionModel> data, string action, string UserName)
        {
            ObjUserRepository = new UserRepository();
            var _db = new workorderEMSEntities();
        ...
        public List<EventModel> GetMyEvents(string  UserName, string start, string end)
        {
            ...
            try
            {
                list= repo.GetMyEvents(UserName, start, end);
        ...
        public bool UpdateInterviewPanel(string selectedManagers, string Manager, string JobId, string JobTitle)
        {
            PerformanceRepository repo = new PerformanceRepository();
            try
            {
        ...
        public List<EventModel> GetBookedSlots(string UserName)
        {
            ...
            try
            {
                return repo.GetBookedSlots(UserName);
            }
            catch (Exception)
            {
                throw;
