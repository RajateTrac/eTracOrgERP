...
namespace WorkOrderEMS.BusinessLogic
{
    public class FillableFormManager : IFillableFormManager
    {
        ...
        /// Created For : To get details of file by employee id
        /// </summary>
        ...
        public FileUpload GetFileDataByEmployeeId(string EmployeeId, string FileName)
        {
            try
            {
                return _FillableFormRepository.GetFileDataByEmployeeId(EmployeeId, FileName);                
            }
            catch (Exception ex)
            {
                Exception_B.Exception_B.exceptionHandel_Runtime(ex, "public FileUpload GetFileDataByEmployeeId(string EmployeeId, string FileName)", "Exception While getting the details of file.", EmployeeId);
                throw;
            }
        }
        /// <summary>
            ...
            try
            {
                if(obj != null)
                {
                    if(obj.FormName == "EducationForm" && obj.EducationFormModel != null)
                    {
                        ...
                        var lsteducatioModel = new List<EducationVarificationModel>();
                        ...
                        lsteducatioModel.Add(educatioModel);
                        _guestRepository.SetEducationVerificationForm(obj.UserId, lsteducatioModel);
                        isSaved = true;
                    }
                    else if (obj.FormName == "DirectDepositForm" && obj.DirectDepositFormModel != null)
                    {
                        ...
                        directDepo.EmployeeBankName1 = obj.DirectDepositFormModel.DDF_BankName_1;
                        directDepo.AccountType1 = obj.DirectDepositFormModel.DDF_AccountType_1;
                        directDepo.Account1 = obj.DirectDepositFormModel.DDF_AccountNumber_1;
                        directDepo.BankRouting1 = obj.DirectDepositFormModel.DDF_BankRountingNumber_1;
                        directDepo.DepositeAmount1 = obj.DirectDepositFormModel.DDF_PercentageOrDollarAmount_1;
                        directDepo.EmployeeBankName2 = obj.DirectDepositFormModel.DDF_BankName_2;
                        directDepo.AccountType2 = obj.DirectDepositFormModel.DDF_AccountType_2;
                        directDepo.Account2 = obj.DirectDepositFormModel.DDF_AccountNumber_2;
                        directDepo.BankRouting2 = obj.DirectDepositFormModel.DDF_BankRountingNumber_2;
                        directDepo.DepositeAmount2 = obj.DirectDepositFormModel.DDF_PercentageOrDollarAmount_2;
