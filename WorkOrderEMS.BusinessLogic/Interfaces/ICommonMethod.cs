...
namespace WorkOrderEMS.BusinessLogic
{
    ...
    public interface ICommonMethod
    {
       ...
       // List<SelectListItem> GetAssetList(long LocationID);
        ...
        List<AssetDropDown> GetAssetListWO(long LocationID);
        List<AssetDropDown> GetAssetList(long LocationID);
        List<LocationListServiceModel> ListAllLocation();
        ...
        List<CustomSlotTime> GetSlotTimings(string EmpId, string date);
