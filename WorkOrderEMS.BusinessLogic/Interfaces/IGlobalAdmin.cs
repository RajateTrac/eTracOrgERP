...
namespace WorkOrderEMS.BusinessLogic
{
    public interface IGlobalAdmin
    {
        ...
        List<UserModel> GetLocationEmployeeWO(long locationId);
        List<GlobalUserModel> GetApplicationAdminDomain();
        List<ContractDropdownDetailsModel> ListContractType();
        List<ContractDropdownDetailsModel> ListCompanyHolder(bool status);
