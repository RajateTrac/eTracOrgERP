...
namespace WorkOrderEMS.Helper
{
    ...
    public class EmailHelper
    {
        ...
        //Added By Ashwajit Bansod for PO Approve Mail
        public string PONumber { get; set; }
        public string ApproveRemoveStatus { get; set; }
        public string LogPOId { get; set; }
        public long? CMPId { get; set; }
        public long LogBillId { get; set; }
        public string LogMiscId { get; set; }
        public string IsCancel { get; set; }

        //Added By Ashwajit Bansod for vendoe
        public string LocationIdsVendor { get; set; }
        ...
        //added by rajat toppo for offer letter date:31-07-2020
        public long? PhoneNo { get; set; }
        public Nullable<DateTime> Currentdate { get; set; }
        public string HRPosition { get; set; }
        public string OlLocationName { get; set; }
        public string OLTitle { get; set; }
        public Nullable<DateTime> DueDate { get; set; }
        public string AssetLost { get; set; }
            ...
            try
            {
                switch (MailType)
                {
                    ...
                    case "EfleetIncidentForService":
                        ...
                        case "URGENTWORKORDERREQUESTTOEMPLOYEE":

                        TemplatePath = ConfigurationManager.AppSettings["UrgentWorkOrderRequestTemplate"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        Subject = "eTrac: Urgent WorkOrder Generated.";
                        strMailHeading = "Welcome to eTrac";
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##Year", Year);
                        strMailBody = strMailBody.Replace("##Logo", LogoPath);
                        ...
                        strMailBody = strMailBody.Replace("##UserName", UserName);
                        strMailBody = strMailBody.Replace("##LocationName", LocationName);
                        strMailBody = strMailBody.Replace("##WorkOrderId", WorkOrderCodeId);
                        strMailBody = strMailBody.Replace("##Sign", "<img height='50px' src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">");
                        break;

                    case "POAPPROVEDREJECT":

                        TemplatePath = ConfigurationManager.AppSettings["POSendForApprovalTemplate"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        Subject = "eTrac: PO Approval.";
                        strMailHeading = "Welcome to eTrac";
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##Year", Year);
                        strMailBody = strMailBody.Replace("##Logo", LogoPath);
                        strMailBody = strMailBody.Replace("##MailHeading", strMailHeading); 
                        strMailBody = strMailBody.Replace("##ManagerName", ManagerName);
                        strMailBody = strMailBody.Replace("##ApproveRemoveStatus", ApproveRemoveStatus);
                        strMailBody = strMailBody.Replace("##PONumber", PONumber);
                        strMailBody = strMailBody.Replace("##UserName", UserName);
                        strMailBody = strMailBody.Replace("##LocationName", LocationName);
                        strMailBody = strMailBody.Replace("##Sign", "<img height='50px' src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">");
                        break;
                    ...
                    case "APPROVED/REJECT":
                        ...
                        TemplatePath = ConfigurationManager.AppSettings["ApprovedRejectPOTemplate"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        Subject = "eTrac: PO Approved/Reject.";
                        strMailHeading = "Welcome to eTrac";
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##Year", Year);
                        strMailBody = strMailBody.Replace("##Logo", LogoPath);
                    ...
                    case "VENDORCREATE":
                        ...
                        TemplatePath = ConfigurationManager.AppSettings["CreateVendorTemplate"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        Subject = "eTrac: Vendor is created";
                        strMailHeading = "Welcome to eTrac";
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##Year", Year);
                        strMailBody = strMailBody.Replace("##Logo", LogoPath);
                        strMailBody = strMailBody.Replace("##MailHeading", strMailHeading);
                        strMailBody = strMailBody.Replace("##VendorId", VendorId);
                        strMailBody = strMailBody.Replace("##VendorName", VendorName);
                        strMailBody = strMailBody.Replace("##LocationName", LocationName);
                        strMailBody = strMailBody.Replace("##Sign", "<img height='50px' src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">");
                        break;

                    case "APPROVEMISCELLANEOUS":

                        TemplatePath = ConfigurationManager.AppSettings["ApproveMiscellaneous"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        Subject = "eTrac: Miscellaneous Approved";
                        strMailHeading = "Welcome to eTrac";
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##Year", Year);
                        strMailBody = strMailBody.Replace("##Logo", LogoPath);
                        strMailBody = strMailBody.Replace("##MailHeading", strMailHeading);
                        strMailBody = strMailBody.Replace("##UserName", UserName);
                        strMailBody = strMailBody.Replace("##MISId", MISId);
                        strMailBody = strMailBody.Replace("##UserName", UserName);
                        strMailBody = strMailBody.Replace("##LocationName", LocationName);
                        strMailBody = strMailBody.Replace("##Sign", "<img height='50px' src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">");
                        break;

                    case "VENDORAPPROVEDREJECT":

                        TemplatePath = ConfigurationManager.AppSettings["ApproveRejectVendorTemplate"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        Subject = "eTrac: Miscellaneous Approved";
                        strMailHeading = "Welcome to eTrac";
                        strMailBody = GetMailBody(TemplatePath);
                    ...
                    case "EMAILDEMOSEND":
                        ...
                        TemplatePath = ConfigurationManager.AppSettings["DailyAPTrendInCountTemplate"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        Subject = "eTrac: Daily AP Trend";
                        strMailHeading = "Welcome to eTrac";
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##Year", Year);
                        strMailBody = strMailBody.Replace("##Logo", LogoPath);
                    ...
                    case "SENDMAILFORMOREBUDGET":

                        TemplatePath = ConfigurationManager.AppSettings["AddMoreBudgetForLocationTemplate"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        Subject = "eTrac: Add Budget for PO";
                        strMailHeading = "Welcome to eTrac";
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##Year", Year);
                        strMailBody = strMailBody.Replace("##Logo", LogoPath);
                        ...
                        strMailBody = strMailBody.Replace("##UserName", UserName);
                        strMailBody = strMailBody.Replace("##VendorName", VendorName); 
                        strMailBody = strMailBody.Replace("##CostCode", CostCode);
                        strMailBody = strMailBody.Replace("##CalculatedAmount", CalculatedAmount);
                        strMailBody = strMailBody.Replace("##REGISTRATIONLINK", RegistrationLink);
                        strMailBody = strMailBody.Replace("##LocationName", LocationName);
                        strMailBody = strMailBody.Replace("##Sign", "<img height='50px' src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">");
                        break;
                    ...
                    case "SENDOFFER":
                        ...
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##UserName", UserName);
                        strMailBody = strMailBody.Replace("##CompanyLogo", LogoPath);
                    ...
                    case "SIGNUPAPPLICANT":
                        ...
                        LogoPath = "<img height='50px' src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";                        
                        ...
                        strMailBody = strMailBody.Replace("##Year", DateTime.Now.Year.ToString());
                        strMailBody = strMailBody.Replace("##Sign", "<img height='50px' src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">");
                        break;
                    ...
                    case "ORIANTATIONDONE":
                        TemplatePath = ConfigurationManager.AppSettings["SendOriantationDone"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        //Subject = "eTrac:Serverance Agreement.";
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##Logo", LogoPath);
                        ...
                        strMailBody = strMailBody.Replace("##UserName", UserName);
                        strMailBody = strMailBody.Replace("##JobTitle", JobTitle);
                        strMailBody = strMailBody.Replace("##AcceptAssessmentLink", AcceptAssessmentLink);
                        strMailBody = strMailBody.Replace("##Sign", "<img height='50px' src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">");
                        break;
                    case "AllASSETSRETURNED":
                        TemplatePath = ConfigurationManager.AppSettings["AllAssetsRecieved"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        Subject = "eTrac:Assets Returned.";
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##Logo", LogoPath);
                        strMailBody = strMailBody.Replace("##EmployeeName", Name);
                        strMailBody = strMailBody.Replace("##EmployeeId", EmployeeId);
                        strMailBody = strMailBody.Replace("##UserName", ManagerName);

                        break;

                    case "ASSETSLOST":
                        TemplatePath = ConfigurationManager.AppSettings["AssetsLostByEmployee"];
                        LogoPath = "<img src=" + ConfigurationManager.AppSettings["hostingPrefix"] + "Images/logo2.png" + ">";
                        Subject = "eTrac:Assets Returned.";
                        strMailBody = GetMailBody(TemplatePath);
                        strMailBody = strMailBody.Replace("##Logo", LogoPath);
                        ...
                        strMailBody = strMailBody.Replace("##EmployeeId", EmployeeId);
                        strMailBody = strMailBody.Replace("##UserName", ManagerName);
                        strMailBody = strMailBody.Replace("##Assetname", AssetLost);
