...
namespace WorkOrderEMS.Data.DataRepository
{
    public class VehicleSeatingChartRepository
    {
        ...
        public int SaveJob(JobPostingModel Obj)
        {
            try
            {
                var data = objworkorderEMSEntities.spSetJobPosting(Obj.AddChartModel.Action,null, Obj.RecruiteeId, Obj.AddChartModel.JobTitleId, Obj.HiringManager, Obj.LocationId, Obj.NumberOfPost,Obj.DOT_Status,Obj.MinimumQualification,"Y");
                return data;
            }
            catch (Exception ex)
            {
