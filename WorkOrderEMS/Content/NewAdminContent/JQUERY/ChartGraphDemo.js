    ...
    if (
        ((this._layoutConfigs = {
            base: {
                ...
                partnerSeparation: this.config.partnerSeparation,
        ...
        for (var a in this.config.tags) {
            ...
            null != n.subTreeConfig &&
                (this._layoutConfigs[a] = {
                    ...
                    partnerSeparation: null != n.subTreeConfig.partnerSeparation ? n.subTreeConfig.partnerSeparation : this.config.partnerSeparation,
...
(OrgChart.prototype.load = function (t) {
    ...
    (OrgChart.prototype._draw = function (t, C, y, O) {
        var v = this;
        ...
        this.server.read(
            ...
            y,
            function (t) {
                C != OrgChart.action.exporting && ((v.nodes = t.nodes), (v.visibleNodeIds = t.visibleNodeIds), (v.roots = t.roots)), (v.editUI.fields = t.allFields);
                var e = { defs: "" };
                OrgChart.events.publish("renderdefs", [v, e]);
                var r = v.ui.defs(e.defs),
                    i = v.getScale(t.viewBox);
                r += v.ui.pointer(v.config, C, i);
                var a = v.getViewBox(),
                    n = t.viewBox;
                e = { content: r, res: t };
                OrgChart.events.publish("prerender", [v, e]), (r = e.content);
                for (var o = 0; o < t.visibleNodeIds.length; o++) {
                    var l = t.nodes[t.visibleNodeIds[o]],
                        s = v._get(l.id);
                    r += v.ui.node(l, s, t.animations, v.config, void 0, void 0, void 0, C, i, v);
                }
                for (o = 0; o < t.visibleNodeIds.length; o++) {
                    (l = t.nodes[t.visibleNodeIds[o]]), (s = v._get(l.id));
                    (r += v.ui.link(l, v, i, t.bordersByRootIdAndLevel)), (r += v.ui.expandCollapseBtn(v, l, v._layoutConfigs, C, i));
                }
                e = { content: r, res: t };
                if ((OrgChart.events.publish("render", [v, e]), (r = e.content), (r += v.ui.lonely(v.config)), C !== OrgChart.action.exporting)) {
                    (C !== OrgChart.action.centerNode && C !== OrgChart.action.insert && C !== OrgChart.action.expand && C !== OrgChart.action.collapse && C !== OrgChart.action.update) || (n = a),
                        ...
                        (v.response = t);
                    m = v.ui.svg(v.width(), v.height(), n, v.config, r);
                    if (v._initialized) {
                        var h = v.getSvg(),
                            d = h.parentNode;
                        d.removeChild(h), d.insertAdjacentHTML("afterbegin", m), v._attachEventHandlers(), v.xScrollUI.addListener(v.getSvg()), v.yScrollUI.addListener(v.getSvg()), v.xScrollUI.setPosition(), v.yScrollUI.setPosition();
                    } else
                        (v.element.innerHTML = v.ui.css() + v.ui.exportMenuButton(v.config) + m),
                            v._attachInitEventHandlers(),
                            v._attachEventHandlers(),
                            v.xScrollUI.create(v.width(), v.config.padding),
                            v.xScrollUI.setPosition(),
                            v.xScrollUI.addListener(v.getSvg()),
                            v.yScrollUI.create(v.height(), v.config.padding),
                    ...
                    var g = v.response.animations;
                    if (0 < g[0].length) {
                        v._hideBeforeAnimation(g[0].length);
                        for (o = 0; o < g[0].length; o++) g[0][o] = v.getNodeElement(g[0][o]);
                        OrgChart.anim(g[0], g[1], g[2], v.config.anim.duration, v.config.anim.func, function () {
                            c || (O && O(), OrgChart.events.publish("redraw", [v]), v._showAfterAnimation(), (c = !0));
                        });
                    }
                    C === OrgChart.action.centerNode
                        ? OrgChart.anim(
                            ...
                            v.config.anim.duration,
                            v.config.anim.func,
                            function () {
                                v.ripple(y.options.rippleId), c || (O && O(), OrgChart.events.publish("redraw", [v]), v._showAfterAnimation(), (c = !0));
                            },
                            function () {
                                v.xScrollUI.setPosition(), v.yScrollUI.setPosition();
                            }
                        )
                        : !a ||
                            !v.response ||
                            (a[0] == v.response.viewBox[0] && a[1] == v.response.viewBox[1] && a[2] == v.response.viewBox[2] && a[3] == v.response.viewBox[3]) ||
                            ...
                            ? 0 == g[0].length && (c || (O && O(), OrgChart.events.publish("redraw", [v]), (c = !0)))
                            : OrgChart.anim(v.getSvg(), { viewbox: a }, { viewbox: v.response.viewBox }, 500, OrgChart.anim.inOutPow, function () {
                                v.xScrollUI.setPosition(), v.yScrollUI.setPosition(), c || (O && O(), OrgChart.events.publish("redraw", [v]), (c = !0));
                            }),
                        v._initialized || ((v._initialized = !0), OrgChart.events.publish("init", [v]));
                } else {
                    var p = t.boundary,
                        f = p.maxX - p.minX,
                        u = p.maxY - p.minY,
                        m = v.ui.svg(f, u, [p.minX, p.minY, f, u], v.config, r, i);
                    O(m);
                }
            },
            function (t) {
        ...
        if (null != i) {
            ...
            if (null != a) {
                ...
                var h = i.w,
                    ...
                    y = OrgChart.randomId();
                u.setAttribute("id", y);
                var O = OrgChart.t(i.templateName, i.min, this.getScale());
                ...
                for (var t = 0; t < c.length; t++)
                    for (var e in p[t]) {
                        ...
                        switch (e.toLowerCase()) {
                            case "d":
                                var i = u((10 * O - 10) / f) * (p[t][e][0] - g[t][e][0]) + g[t][e][0],
                                    a = u((10 * O - 10) / f) * (p[t][e][1] - g[t][e][1]) + g[t][e][1];
                                c[t].setAttribute("d", c[t].getAttribute("d") + " L" + i + " " + a);
                                break;
                            case "r":
                                var n = u((10 * O - 10) / f) * (p[t][e] - g[t][e]) + g[t][e];
                            ...
                            case "transform":
                                if (p[t][e]) {
                                    var o = g[t][e],
                                        l = p[t][e],
                                        s = [0, 0, 0, 0, 0, 0];
                                    for (var h in o) s[h] = u((10 * O - 10) / f) * (l[h] - o[h]) + o[h];
                                    c[t].hasAttribute("transform") ? c[t].setAttribute("transform", "matrix(" + s.toString() + ")") : (c[t].style.transform = "matrix(" + s.toString() + ")");
                                }
                                break;
                            case "viewbox":
                                if (p[t][e]) {
                                    for (var h in ((o = g[t][e]), (l = p[t][e]), (s = [0, 0, 0, 0]), o)) s[h] = u((10 * O - 10) / f) * (l[h] - o[h]) + o[h];
                            ...
                            case "margin":
                                ...
                                break;
                            default:
                                (n = u((10 * O - 10) / f) * (p[t][e] - g[t][e]) + g[t][e]), c[t] && c[t].style && (c[t].style[e] = n + r);
                        }
                    }
                C && C(), 1 + v < (O += 1) && (clearInterval(y), m && m(c));
            }, 10));
    }),
    ...
    (OrgChart.nodeOpenTag = '<g node-id="{id}" style="opacity: {opacity}" transform="matrix(1,0,0,1,{x},{y})" class="{class}" sl="{sl}" {lcn}>'),
    ...
    (OrgChart.OFFLINE_MESS = "The evaluation version requires internet connection! <br /><a style='color: #039BE5;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>"),
                    ...
                    a.addEventListener("click", function (t) {
                        ...
                        if (void 0 === l[r].onClick)
                            if ("add" === r) {
                                ...
                                $.ajax({
                                    type: "GET",
                                    url: origin_Url + '/EPeople/OpenJobPostingForm?CSVChartId=' + i.pid, //'@Url.Action("SaveVCS", "AdminDashboard", new { area = "AdminSection" })',
                                    success: function (Data) {
                                        ...
                                        //} else {
                                        //    $("#SaveJobPost").hide();
                                        //    $("#divOpenJobPostForm").html("You are not able to post job for this seating name. Access denied.")
                                        //}
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: '../AdminSection/AdminDashboard/GetChartDetailsById?CSVChartId=' + a.id, //'@Url.Action("SaveVCS", "AdminDashboard", new { area = "AdminSection" })',
                                    success: function (Data) {

                                        var roles;
                                        if (Data != null) {
                                            $("#SeatingName").val(Data.SeatingName);
                                            $("#Superior").val(Data.parentId);
                                            ...
                                            if (Data.JobDescription != null) {
                                                ...
                                                for (var ii = 0; ii < getJobData.length; ii++) {
                                                    ...
                                                    if (ii == 0) {
                                                        $("#JobDescription").val(getJobData[ii]);
                                                    }
                                                    else {
                                                        if (getJobData[ii] != "" && getJobData[ii] != " ") {
                                        ...
                                        $("#RolesAndResponsibilityRequisition").val(roles);
                                        $("#parentIdForJobTitle").val(a.id);
                                    },
                                    error: function (err) {
                                    }
                                });
    ...
    (OrgChart.icon.png = function (t, e, r) {
        return (
            ...
            '" height="' +
            e +
            '" viewBox="-30,-105.83792971864489,2237.488171982409,1277.5217947697276"><path fill="' +
            r +
    ...
    (OrgChart.prototype._pagesA100 = function (t, e, r) {
        ...
        for (var g = o, p = l, f = d.w * (100 / r) - o, u = d.h * (100 / r), m = []; g < s - 1;) {
            for (; p < h - 1;) {
                var C = [g, p, g + f, u];
                (C = C.join()), m.push({ vb: C, innerSize: d, size: c }), (p += u - l);
            }
            (g += f), (p = l);
        }
        return m;
        ...
        if (this.config.enableDragDrop) {
            ...
            if (!1 !== OrgChart.events.publish("drag", [this, a])) {
                ...
                var x = this,
                    ...
                    I = x.getScale(),
                    A = t.cloneNode(!0);
                b.insertBefore(A, b.firstChild), (A.style.opacity = 0.7);
                var L = function (t, e) {
                    if (null != t) {
                        e.style.opacity = 1;
                        for (var r = x.getNode(O), i = OrgChart.getStParentNodes(r), a = 0; a < i.length; a++) {
                            var n = x.getNodeElement(i[a].id);
                            n && (n.style.opacity = 1);
                        }
                    }
                },
                    n = function (t) {
                        if (w) {
                            var e = OrgChart._getClientXY(t),
                                ...
                                i = OrgChart._getOffsetXY(x.element, t),
                                a = { left: x.width() - (i.x + x.config.padding) < 0, right: i.x - x.config.padding < 0, down: x.height() - (i.y + x.config.padding) < 0, up: i.y - x.config.padding < 0 };
                            if (a.left || a.right || a.up || a.down) {
                                b.classList && (b.classList.remove("cursor-grab"), b.classList.add("cursor-move"), b.classList.remove("cursor-nodrop"), b.classList.remove("cursor-copy"));
                                var n = k[4],
                                    o = k[5],
                                    l = w.x,
                                    s = w.y,
                                ...
                                x.startMove(a, function (t) {
                                    (k[4] = n + t.x),
                                        ...
                                        A.setAttribute("transform", "matrix(" + k.toString() + ")");
                                });
                            } else {
                                if (
                                    (x.stopMove(),
                                        b.classList && (b.classList.add("cursor-grab"), b.classList.remove("cursor-move"), b.classList.remove("cursor-nodrop"), b.classList.remove("cursor-copy")),
                                        L(O, v),
                                        (v = O = null),
                                        x.config.enableDragDrop)
                                )
                                    for (; null != r && r != b;) {
                                        debugger
                                        if (r.hasAttribute && r.hasAttribute("node-id")) {
                                            var c = r.getAttribute("node-id");
                                            if (x._gragStartedId && c != x._gragStartedId) {
                                                (O = c), (v = r);
                                                break;
                                            }
                                        }
                                ...
                                if (null != O) {
                                    v.style.opacity = 0.5;
                                    for (var g = x.getNode(O), p = OrgChart.getStParentNodes(g), f = 0; f < p.length; f++) {
                                        var u = x.getNodeElement(p[f].id);
                                        u && (u.style.opacity = 0.1);
                                    }
                                    !x._canUpdateLink(y.id, O) && b.classList
                                        ...
                                        : b.classList && (b.classList.remove("cursor-grab"), b.classList.remove("cursor-move"), b.classList.add("cursor-copy"), b.classList.remove("cursor-nodrop"));
                                }
                                var m = (e.x - w.x) / I,
                                    C = (e.y - w.y) / I;
                                (k[4] = _ + m), (k[5] = S + C), A.setAttribute("transform", "matrix(" + k.toString() + ")");
                            }
                        }
                    },
                    o = function (t) {
                        if (
                            (x.stopMove(),
                                b.classList && (b.classList.remove("cursor-grab"), b.classList.remove("cursor-move"), b.classList.remove("cursor-nodrop"), b.classList.remove("cursor-copy")),
                                b.removeEventListener(i.move, n),
                                b.removeEventListener(i.up, o),
                                i.leave && b.removeEventListener(i.leave, o),
                                y.id == O || null == O)
                        )
                            return b.removeChild(A), void (x._gragStartedId = null);
                        var e = x.getNode(O);
                        if (!1 === OrgChart.events.publish("drop", [x, y.id, e.id])) return L(O, v), b.removeChild(A), void (x._gragStartedId = null);
                        if (x._canUpdateLink(y.id, O)) {
                            var r = x.get(y.id);
                            (r.pid = O), (r.stpid = null), x.updateNode(r, null, !0);
                        } else b.removeChild(A), L(O, v);
                        x._gragStartedId = null;
                    };
...
(OrgChart.prototype._mouseDownHandler = function (t, e, r) {
    ...
    if ("pan" == c.type) {
        ...
        (n.style.display = "inherit"),
            ...
            OrgChart.anim(n, { transform: [0, 0, 0, 0, l, g], opacity: 0 }, { transform: [1 / d, 0, 0, 1 / d, l, g], opacity: 1 }, 300, OrgChart.anim.outBack);
    }
    var p = function (t) {
    ...
    (OrgChart.remote._toReqLayoutConfigsDTO = function (t) {
        ...
        for (var r in t) {
            ...
            e[r] || (e[r] = []),
                ...
                (e[r][9] = i.partnerSeparation),
                (e[r][10] = i.partnerNodeSeparation);
        }
        return e;
    }),
    ...
    (OrgChart.server.prototype.read = function (t, r, i, e, a, n, o, l) {
        ...
        var h = this.maxX,
            ...
            c = this.minX,
            g = this.minY,
            p = this.bordersByRootIdAndLevel,
            f = this.roots,
            u = this.nodes;
        if (t) {
            var m = OrgChart.server._getResponse(r, i, this.visibleNodeIds, this.config, h, d, c, g, this.viewBox, f, this.action, this.actionParams, u, this.oldNodes);
            a != OrgChart.action.exporting && ((this.maxX = h), (this.maxY = d), (this.minX = c), (this.minY = g), (this.roots = f), (this.nodes = u), (this.visibleNodeIds = m.visibleNodeIds)),
                (m.bordersByRootIdAndLevel = p),
                (m.roots = f),
                o(m);
        } else
            (this.oldNodes = u || null),
                this._read(function (t) {
                    (h = t.maxX), (d = t.maxY), (c = t.minX), (g = t.minY), (p = t.bordersByRootIdAndLevel), (f = t.roots), (u = t.nodes);
                    var e = OrgChart.server._getResponse(r, i, s.visibleNodeIds, s.config, h, d, c, g, s.viewBox, f, s.action, s.actionParams, u, s.oldNodes);
                    (e.notif = t.limit),
                        (e.roots = f),
                        (e.bordersByRootIdAndLevel = p),
                        a != OrgChart.action.exporting && ((s.maxX = h), (s.maxY = d), (s.minX = c), (s.minY = g), (s.roots = f), (s.nodes = u), (s.visibleNodeIds = e.visibleNodeIds), (s.bordersByRootIdAndLevel = p)),
                        o(e);
                }, l);
    }),
    (OrgChart.server.prototype._read = function (a, t) {
        ...
        null == r && (r = OrgChart.local),
            r._setPositions(
                ...
                this.layoutConfigs,
                function (t) {
                    OrgChart.server._doNotChangePositionOfClickedNodeIfAny(l, o, n.action, n.actionParams, n.oldNodes, n.config.orientation);
                    for (var e = { minX: null, minY: null, maxX: null, maxY: null }, r = {}, i = 0; i < l.length; i++) OrgChart.server._setMinMaxXYIterate(l[i], l[i], e, 0, r);
                    a({ minX: e.minX, minY: e.minY, maxX: e.maxX, maxY: e.maxY, bordersByRootIdAndLevel: r, nodes: o, roots: l, limit: t });
                },
                o
            );
    }),
    (OrgChart.server._setMinMaxXYIterate = function (t, e, r, i, a) {
        OrgChart._setMinMaxXY(t, r);
        for (var n = 0; n < t.stChildren.length; n++) OrgChart.server._setMinMaxXYIterate(t.stChildren[n], t.stChildren[n], r, 0, a);
        t.isPartner ? (t.sl = i - 1) : (t.sl = i), null == a[e.id] && (a[e.id] = {}), null == a[e.id][t.sl] && (a[e.id][t.sl] = { minX: null, minY: null, maxX: null, maxY: null }), OrgChart._setMinMaxXY(t, a[e.id][t.sl]), i++;
        for (n = 0; n < t.children.length; n++) OrgChart.server._setMinMaxXYIterate(t.children[n], e, r, i, a);
    }),
    (OrgChart.server.prototype.find = function (t) {
        ...
        for (
            ...
            for (var d in h) {
                var c = h[d];
                (0 < this.config.searchFields.length && -1 == this.config.searchFields.indexOf(d)) ||
                    (c &&
                        -1 != OrgChart.accentFold(c).indexOf(t) &&
                        !OrgChart._fieldIsImg(this.config, d) &&
                        o.push({ id: h.id, propertyName: d, isId: d == OrgChart.ID, isNodeParam: n(d), weight: OrgChart.accentFold(c).indexOf(t), data: h }));
            }
        }
        o.sort(function (t, e) {
                        ...
                        (d == OrgChart.ID
                            ...
                            : OrgChart._fieldIsImg(this.config, d)
                                ...
                                : n(d) && !OrgChart._fieldIsImg(this.config, d)
                                    ? (f = f + c + ", ")
                                    : OrgChart._fieldIsImg(this.config, d) || (m = m + c + ", "));
                }
                (u = u.slice(0, u.length - 2)), (f = f.slice(0, f.length - 2)), (m = m.slice(0, m.length - 2));
                var O = OrgChart._getTemplate(o[s].tags, this.config.tags, this.config.template);
                l.push({ id: o[s].id, node: new OrgChart.node(o[s], null, [], O), textId: u, textInNode: f, text: m, img: C });
            }
        }
        return l;
    }),
    ...
    (OrgChart.server._initNode = function (t, e, r, i, a, n, o, l, s, h) {
        for (var d = n[r || "base"], c = 0; c < t.childrenIds.length; c++) {
            null == (g = e[t.childrenIds[c]]).collapsed && d.collapse && d.collapse.allChildren ? (g.collapsed = !0) : null == g.collapsed && (g.collapsed = !1),
                a == OrgChart.action.expand && -1 != s.ids.indexOf(g.id) && (g.collapsed = !1),
                a == OrgChart.action.collapse && -1 != s.ids.indexOf(g.id) && (g.collapsed = !0),
                a == OrgChart.action.expand && "all" == s.ids && (g.collapsed = !1),
                a == OrgChart.action.exporting && s.expandChildren && (g.collapsed = !1),
                a == OrgChart.action.init
                    ? (g.collapsed = d.collapse && i >= d.collapse.level - 1 && -1 == l.indexOf(g.id))
                    : (a != OrgChart.action.centerNode && a != OrgChart.action.insert) || (-1 != l.indexOf(g.id) && (g.collapsed = !1)),
                g.collapsed ||
                ((g.parent = t), (-1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") && -1 == g.tags.indexOf("partner") && null == g.ppid) || (-1 == h.indexOf(t.id) && h.push(t.id)), t.children.push(g));
        }
        if ((t.min || a != OrgChart.action.minimize || s.id != t.id || (t.min = !0), !0 === t.min && a == OrgChart.action.maximize && s.id == t.id && (t.min = !1), !t.min))
            for (c = 0; c < t.stChildrenIds.length; c++) {
                var g;
                ((g = e[t.stChildrenIds[c]]).stParent = t).stChildren.push(g);
            }
        var p = OrgChart.t(t.templateName, t.min);
        (t.w = p && p.size ? p.size[0] : 0), (t.h = p && p.size ? p.size[1] : 0), (t.padding = p && p.padding ? p.padding : [0, 0, 0, 0]), null != i && (t.level = i), r && (t.lcn = r);
        var f = OrgChart._getSubLevels(t.tags, o.tags);
        0 < f && (t.subLevels = f), -1 != t.tags.indexOf("assistant") && (t.isAssistant = !0);
    }),
    (OrgChart.server._iterate = function (t, e, r, i, a, n, o, l, s, h, d, c, g, p, f) {
        if (
            (OrgChart.server._initNode(e, r, s, i, c, h, d, g, p, f),
            ...
            for (var u = [], m = 0, C = 0, y = 0; y < e.parent.children.length; y++) {
                var O = e.parent.children[y];
                -1 == O.tags.indexOf("partner") && -1 == O.tags.indexOf("assistant") && 0 == O.childrenIds.length ? u.push(O.id) : -1 != O.tags.indexOf("assistant") ? m++ : -1 != O.tags.indexOf("partner") && C++;
            }
            OrgChart.MIXED_LAYOUT_ALL_NODES && 1 < u.length && u.length == e.parent.childrenIds.length - m - C ? (l[e.pid] = u) : !OrgChart.MIXED_LAYOUT_ALL_NODES && 1 < u.length && (l[e.pid] = u);
        }
        e.stChildren.length && (t.stContainerNodes || (t.stContainerNodes = []), t.stContainerNodes.push(e));
        for (var v = 0; v < e.stChildren.length; v++) {
            var x = "";
            for (y = 0; y < e.tags.length; y++)
                if (h[e.tags[y]]) {
                    x = e.tags[y];
                    break;
                }
            a.push(e.stChildren[v].id), OrgChart.server._iterate(t, e.stChildren[v], r, 0, a, n, o, l, x, h, d, c, g, p, f);
        }
        i++;
        for (v = 0; v < e.children.length; v++) OrgChart.server._iterate(t, e.children[v], r, i, a, n, o, l, s, h, d, c, g, p, f);
    }),
    (OrgChart.server._createNodes = function (a, t, e, r, i) {
        for (var n = a.nodes, o = {}, l = [], s = [], h = 0; h < n.length; h++) {
            var d = n[h],
                c = Array.isArray(d.tags) ? d.tags.slice(0) : [],
                g = OrgChart._getTemplate(c, a.tags, a.template),
                p = new OrgChart.node(d.id, d.pid, c, g);
            null != d.ppid && (p.ppid = d.ppid), d.stpid && (p.stpid = d.stpid), null != a.orderBy && (p.order = OrgChart.server._getOrderFieldValue(d, a.orderBy)), (o[d.id] = p), l.push(d.id);
        }
        null != a.orderBy &&
            l.sort(function (t, e) {
                var r = o[t].order,
        ...
        for (h = 0; h < l.length; h++) {
            ...
            } else C ? (u && ((p.collapsed = u.collapsed), (p.min = u.min)), C.childrenIds.push(p.id)) : (u && ((p.collapsed = u.collapsed), (p.min = u.min)), s.push(p));
            e == OrgChart.action.init && (p.min = OrgChart._getMin(p, a));
        }
        if (null != a.roots) {
            s = [];
            for (h = 0; h < a.roots.length; h++) {
                var O = o[a.roots[h]];
                O && s.push(O);
            }
        }
        ...
        if (e == OrgChart.action.init && a.expand && a.expand.nodes)
            ...
            for (var x = o[r.id]; x;) {
                if ((v.push(x.id), r.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && x))
                    for (h = 0; h < x.childrenIds.length; h++) {
                        (F = o[x.childrenIds[h]]).collapsed = !0;
                    }
            ...
            if (r.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
                for (h = 0; h < x.childrenIds.length; h++) {
                    (w = o[x.childrenIds[h]]).collapsed = !1;
                    for (var b = 0; b < w.childrenIds.length; b++) {
                        o[w.childrenIds[b]].collapsed = !0;
                    }
                }
            if (r.options.parentState === OrgChart.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED)
                if ((C = o[x.pid]))
                    for (h = 0; h < C.childrenIds.length; h++) {
                        var w;
                        if ((w = o[C.childrenIds[h]]) != x) {
                            w.collapsed = !1;
                            for (b = 0; b < w.childrenIds.length; b++) {
                                o[w.childrenIds[b]].collapsed = !0;
                            }
                        }
                    }
        } else if (e == OrgChart.action.insert) for (p = o[r.insertedNodeId]; p;) v.push(p.id), null == p.pid && null != p.stpid ? ((p = o[p.stpid]).min = !1) : (p = o[p.pid]);
        var k = [],
            _ = {},
            S = [],
            I = {},
            A = [];
        for (h = 0; h < s.length; h++) OrgChart.server._iterate(s[h], s[h], o, 0, k, _, S, I, "", t, a, e, v, r, A);
        for (h = 0; h < A.length; h++) {
            ...
            var L = [],
                ...
                B = 0,
                z = 0;
            for (b = 0; b < p.children.length; b++) {
                (F = p.children[b]).isAssistant ||
                    (-1 != F.tags.indexOf("right-partner")
                        ? ((F.isPartner = 1), (F.children = []), M.push(F.id))
                        : -1 != F.tags.indexOf("left-partner")
                            ? ((F.isPartner = 2), (F.children = []), E.push(F.id))
                            : -1 == F.tags.indexOf("partner") || T % 2
                                ? -1 != F.tags.indexOf("partner") && T % 2
                                    ? ((F.isPartner = 2), (F.children = []), E.push(F.id), T++)
                                    : null != F.ppid
                                        ? (N[F.ppid] || (N[F.ppid] = []), N[F.ppid].push(F.id))
                                        : L.push(F.id)
                                : ((F.isPartner = 1), (F.children = []), M.push(F.id), T++));
            }
            p.children = [];
            ...
            for (b = E.length - 1; 0 <= b; b--) if (N[E[b]]) for (var H = 0; H < N[E[b]].length; H++) p.children.push(o[N[E[b]][H]]), B++;
            for (b = 0; b < L.length; b++) {
                F = o[L[b]];
                p.children.push(F);
            }
            for (b = 0; b < M.length; b++) if (N[M[b]]) for (H = 0; H < N[M[b]].length; H++) p.children.push(o[N[M[b]][H]]), z++;
            L.length || !B || z
                ? L.length || B || !z
                    ? L.length || 1 != B || 1 != z
                        ? L.length || B || z
        ...
        for (h = 0; h < S.length; h++)
            for (p = o[S[h]], b = 0; b < p.subLevels; b++) {
                var P = new OrgChart.node(p.id + "_sub_level_index_" + b, p.pid, [], "subLevel");
                if ((OrgChart.server._initDinamicNode(P, p.lcn), (C = p.parent))) {
                    var U = C.children.indexOf(p);
                    -1 < U && (C.children.splice(U, 1), C.children.splice(U, 0, P)), P.children.push(p), (P.parent = C), (p.parent = P), (o[P.id] = P);
                }
            }
        for (var j in _) {
            (C = o[j]), (P = new OrgChart.node(C.id + "_split_0", C.id, ["assistant"], "split"));
            OrgChart.server._initDinamicNode(P, C.lcn, !0), (o[P.id] = P);
            var R = [];
            for (b = C.children.length - 1; 0 <= b; b--) {
                (F = C.children[b]).isAssistant ? ((F.parent = null), C.children.splice(b, 1), R.splice(0, 0, F.id)) : F.isPartner || ((F.parent = P).children.unshift(F), C.children.splice(b, 1));
            }
            if (R.length % 2) {
                var D = o[R[R.length - 1]],
                    Y = new OrgChart.node(D.id + "_mirror", D.pid, [], "mirror");
                OrgChart.server._initDinamicNode(Y, D.lcn, !0), (D._m = Y.id), (Y.isAssistant = !0), (Y.w = D.w), (Y.h = D.h), (o[Y.id] = Y), R.splice(R.length - 1, 0, Y.id);
            }
            var X = 1;
            for (b = R.length - 1; 0 <= b; b--)
                if (b % 2 && b != R.length - 1) {
                    var q = new OrgChart.node(C.id + "_split_" + X, null, [], "split");
                    OrgChart.server._initDinamicNode(q, C.lcn, !0), (o[q.id] = q), R.splice(b, 0, q.id), X++;
                } else b % 2 && R.splice(b, 0, P.id);
            for (b = 0; b < R.length; b += 3) {
                ...
                var W = o[R[b]],
                    G = o[R[b + 1]],
                    J = o[R[b + 2]];
                (W.parent = V), (G.parent = V), (J.parent = V).children.push(W), V.children.push(G), V.children.push(J);
            }
        }
        var K = !1;
        for (var Z in t) {
            if ((et = t[Z]).layout == OrgChart.mixed) {
                K = !0;
                break;
            }
        }
        if (K)
            for (var j in I) {
                if ((et = t[(C = o[j]).lcn ? C.lcn : "base"]).layout == OrgChart.mixed) {
                    var $ = I[j];
                    for (h = $.length - 1; 0 <= h; h--) {
                        if (((C = (F = o[$[h]]).parent), (F.layout = OrgChart.mixed), 0 < h)) {
                            for (b = C.children.length - 1; 0 <= b; b--) F.id == C.children[b].id && C.children.splice(b, 1);
                            var Q = o[$[h - 1]];
                            (F.parent = Q), (F.layout = OrgChart.mixed), Q.children.push(F);
                        }
                    }
                }
            }
        var tt = !1;
        for (var Z in t) {
            if ((et = t[Z]).layout == OrgChart.tree || et.layout == OrgChart.treeRightOffset || et.layout == OrgChart.treeLeftOffset) {
                tt = !0;
                break;
            }
        }
        if (tt)
            for (var j in I) {
                var et;
                if ((et = t[(C = o[I[j][0]].parent).lcn ? C.lcn : "base"]).layout == OrgChart.tree || et.layout == OrgChart.treeRightOffset || et.layout == OrgChart.treeLeftOffset) {
                    P = new OrgChart.node(C.id + "_split_0", C.id, [], "split");
                    OrgChart.server._initDinamicNode(P, C.lcn), ((o[P.id] = P).layout = OrgChart.tree);
                    var rt = [];
                    for (h = I[j].length - 1; 0 <= h; h--) {
                        for (F = o[I[j][h]], b = 0; b < C.children.length; b++) C.children[b].id == F.id && C.children.splice(b, 1);
                        if (((F.parent = null), (F.layout = OrgChart.tree), et.layout == OrgChart.treeRightOffset && rt.splice(0, 0, F.id), et.layout == OrgChart.treeLeftOffset || et.layout == OrgChart.treeRightOffset)) {
                            var it = new OrgChart.node(F.id + "_mirror", null, [], "mirror");
                            OrgChart.server._initDinamicNode(it, F.lcn), (it.layout = OrgChart.tree), (o[it.id] = it), rt.splice(0, 0, it.id);
                        }
                        et.layout != OrgChart.treeRightOffset && rt.splice(0, 0, F.id);
                    }
                    for (X = 1, b = rt.length - 1; 0 <= b; b--)
                        if (b % 2 && b != rt.length - 1) {
                            q = new OrgChart.node(C.id + "_split_" + X, null, [], "split");
                            OrgChart.server._initDinamicNode(q, C.lcn), (q.layout = OrgChart.tree), (o[q.id] = q), rt.splice(b, 0, q.id), X++;
                        } else b % 2 && rt.splice(b, 0, P.id);
                    for (b = 0; b < rt.length; b += 3) {
                        V = null;
                        0 == b && (V = C);
                        (W = o[rt[b]]), (G = o[rt[b + 1]]), (J = o[rt[b + 2]]);
                        0 != b && (V = o[rt[b - 3]]),
                            0 == b || G || (V = o[rt[b - 2]]),
                            (W.parent = V).children.push(W),
                            G && (0 != b && (V = o[rt[b - 2]]), (G.parent = V).children.push(G)),
                            J && (0 != b && (V = o[rt[b - 1]]), (J.parent = V).children.push(J));
                    }
                }
            }
    ...
    (OrgChart.server._getResponse = function (t, e, r, i, a, n, o, l, s, h, d, c, g, p) {
        var f = h[0],
            u = [],
            ...
            y = a - o + 2 * i.padding,
            O = n - l + 2 * i.padding,
            v = OrgChart.getScale(s, t, e, i.scaleInitial, i.scaleMax, i.scaleMin, y, O);
        if (((m.top = l - i.padding), (m.left = o - i.padding), (m.bottom = n + i.padding - e / v), (m.right = a + i.padding - t / v), (m.maxX = a), (m.minX = o), (m.maxY = n), (m.minY = l), null == s && i.align == OrgChart.CENTER)) {
            var x = Math.ceil(t / v),
                b = Math.ceil(e / v),
                w = 0,
                k = 0;
            if (x - 2 * i.padding >= a - o)
                ...
                switch (((w = f.x - x / 2 + OrgChart.server._getNodeWidth(f, i) / 2), i.orientation)) {
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
            ...
            (x = Math.ceil(t / v)), (b = Math.ceil(e / v)), (w = 0), (k = 0);
            switch (i.orientation) {
                case OrgChart.orientation.top:
                    (w = f.x - x / 2 + OrgChart.server._getNodeWidth(f, i) / 2), (k = -i.padding);
                    break;
                case OrgChart.orientation.bottom:
                    (w = f.x - x / 2 + OrgChart.server._getNodeWidth(f, i) / 2), (k = i.padding - b);
                    break;
                case OrgChart.orientation.left:
                    (w = -i.padding), (k = f.y - b / 2 + OrgChart.server._getNodeWidth(f, i) / 2);
                    break;
                case OrgChart.orientation.right:
                    (w = i.padding - x), (k = f.y - b / 2 + OrgChart.server._getNodeWidth(f, i) / 2);
                    break;
                case OrgChart.orientation.top_left:
        ...
        if (d == OrgChart.action.centerNode || d == OrgChart.action.maximize) {
            var _ = g[c.id];
            1 == c.options.horizontal && (s[0] = _.x + _.w / 2 - s[2] / 2),
                1 == c.options.vertical && (s[1] = _.y + _.h / 2 - s[3] / 2),
                i.sticky &&
        ...
        if (d == OrgChart.action.insert || d == OrgChart.action.expand || d == OrgChart.action.collapse || d == OrgChart.action.update || d == OrgChart.action.centerNode || d == OrgChart.action.maximize) {
            var S = null;
            if (d == OrgChart.action.insert && c && null != c.insertedNodeId && null != c.insertedNodeId) S = g[c.insertedNodeId];
            else if (d == OrgChart.action.update && c && null != c.visId && null != c.visId) S = g[c.visId];
                ...
                if (d == OrgChart.action.centerNode || d == OrgChart.action.maximize) {
                    switch (i.orientation) {
                        ...
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            c.options.vertical || (S = g[c.id]);
                            break;
                        case OrgChart.orientation.right:
                        case OrgChart.orientation.right_top:
                        case OrgChart.orientation.left:
                        case OrgChart.orientation.left_top:
                            c.options.horizontal || (S = g[c.id]);
                    }
                    S && (S = OrgChart.server._getMostDeepChild(S, g));
                }
            } else (S = g[c.id]), (S = OrgChart.server._getMostDeepChild(S, g));
            if (S)
                switch (i.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        var I = S.y + S.h - s[3] + i.padding;
                        s[1] < I && (s[1] = I);
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                    ...
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        I = S.x + S.w - s[2] + i.padding;
                        s[0] < I && (s[0] = I);
                }
        }
        for (var A = 0; A < h.length; A++) OrgChart.server._iterate2(h[A], g, i, s, d, c, u, p, r, C);
    ...
    (OrgChart.server._iterate2 = function (t, e, r, i, a, n, o, l, s, h) {
        if (OrgChart.server._isVisible(t, r, i, a)) {
            ...
            if ((a == OrgChart.action.expand || a == OrgChart.action.collapse || a == OrgChart.action.maximize) && l && l[t.id] && "expandCollapseToLevel" == n.method) {
                ...
                if ((null != (u = l[t.id]).x && null != u.y && (d = { x: u.x, y: u.y }), (f = e[n.id]) && f == t)) (c = t.parent) && c.id == n.id && (d = { x: f.x + f.w / 2 - t.w / 2, y: f.y + f.h / 2 - t.h / 2 });
    ...
    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:block;" width="{w}" height="{h}" viewBox="-30,-86.06319095030032,2237.488171982409,1277.5217947697276">{content}</svg>',
    ...
    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  style="display:block;" width="{w}" height="{h}" viewBox="-30,-86.06319095030032,2237.488171982409,1277.5217947697276">{content}</svg>',
        ...
        link_field_0: '<text text-anchor="middle" fill="#aeaeae" width="290" x="0" y="0" style="font-size:10px;">{val}</text>',
        field_0: '<text width="230" style="font-size: 18px;" fill="#ffffff" x="125" y="22" text-anchor="middle">{val}</text>',
    ...
    (OrgChart.templates.rony.svg = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="background-color:#E8E8E8;display:block;" width="{w}" height="{h}" viewBox="-30,-86.06319095030032,2237.488171982409,1277.5217947697276">{content}</svg>'),
    ...
    (OrgChart.templates.luba.svg = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:block;background-color: #2E2E2E;" width="{w}" height="{h}" viewBox="-30,-86.06319095030032,2237.488171982409,1277.5217947697276">{content}</svg>'),
    ...
    (OrgChart.ui = {
        ...
        node: function (t, e, r, i, a, n, o, l, s, h) {
            ...
            for (var g in (d.defs && (c = c.replace("{randId}", OrgChart.ui._defsIds[t.templateName])), null == o && (o = i.nodeBinding), o)) {
                ...
                if (e) {
                    var f = e[p];
                    if (("function" == typeof p && (f = p(h, t)), null != f && null != f && null != d[g]))
                        c += (OrgChart._lblIsImg(i, g) || "string" != typeof f || (f = OrgChart.wrapText(f, d[g])), d[g].replace("{val}", f))
            ...
            var C = "";
            t.lcn && (C = 'lcn="' + t.lcn + '"');
            var y = OrgChart.nodeOpenTag.replace("{lcn}", C).replace("{id}", t.id).replace("{class}", m).replace("{sl}", t.sl).replace("{x}", u.x).replace("{y}", u.y),
                O = OrgChart._getOpacity(r, t);
            ((y = y.replace("{opacity}", O)), null != i.nodeMenu && "split" != t.templateName && l !== OrgChart.action.exporting) &&
                (c += d.nodeMenuButton
                    .replace("{id}", t.id)
                    .replace("{cw}", t.w / 2)
        ...
        expandCollapseBtn: function (t, e, r, i, a) {
            var n = "";
            if (i !== OrgChart.action.exporting && 0 < e.childrenIds.length && "split" != e.templateName && (null == e.hasPartners || 6 == e.hasPartners)) {
                if (e.hasPartners) {
                    for (var o = !0, l = 0; l < e.children.length; l++) e.children[l].isPartner || (o = !1);
                    if (o) return;
                }
                ...
                if (
                    ((h -= c.expandCollapseSize / 2),
                        ...
                        t.getCollapsedIds(e).length
                            ? ((n += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", h).replace("{y}", d)), (n += c.plus))
                            : ((n += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", h).replace("{y}", d)), (n += c.minus)),
        ...
        link: function (t, e, r, i) {
            var a = t.lcn ? t.lcn : "base",
                n = e._layoutConfigs[a],
                o = OrgChart.t(t.templateName, t.min, r),
                l = [],
                s = n.levelSeparation / 2;
            (t.layout != OrgChart.mixed && t.layout != OrgChart.tree) || (s = n.mixedHierarchyNodesSeparation / 2);
            for (var h = OrgChart.getRootOf(t).id, d = i[h][t.sl], c = 0; c < t.children.length; c++) {
                var g = t.children[c],
                    p = i[h][g.sl],
                    f = { xa: 0, ya: 0, xb: 0, yb: 0, xc: 0, yc: 0, xd: 0, yd: 0, x: 0, y: 0, rotate: 0 },
                    u = (o = OrgChart.t(g.templateName, g.min, r)).link;
                if ((g.isAssistant || 2 == g.layout) && g.rightNeighbor && g.rightNeighbor.isSplit)
                    switch (n.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                            f = OrgChart.ui._linkRightToLeft(g.rightNeighbor, g, o, s);
                            break;
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            f = OrgChart.ui._linkRightToLeft(g.rightNeighbor, g, o, s);
                        ...
                        case OrgChart.orientation.right:
                        case OrgChart.orientation.right_top:
                            f = OrgChart.ui._linkBottomToTop(g.rightNeighbor, g, o, s);
                            break;
                        case OrgChart.orientation.left:
                        case OrgChart.orientation.left_top:
                            f = OrgChart.ui._linkBottomToTop(g.rightNeighbor, g, o, s);
                    }
                else if ((g.isAssistant || 2 == g.layout) && g.leftNeighbor && g.leftNeighbor.isSplit)
                    switch (n.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                            f = OrgChart.ui._linkLeftToRight(g.leftNeighbor, g, o, s);
                            break;
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            f = OrgChart.ui._linkLeftToRight(g.leftNeighbor, g, o, s);
                        ...
                        case OrgChart.orientation.right:
                        case OrgChart.orientation.right_top:
                            f = OrgChart.ui._linkTopToBottom(g.leftNeighbor, g, o, s);
                            break;
                        case OrgChart.orientation.left:
                        case OrgChart.orientation.left_top:
                            f = OrgChart.ui._linkTopToBottom(g.leftNeighbor, g, o, s);
                    ...
                    switch (n.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                            if (1 == g.isPartner) f = OrgChart.ui._linkLeftToRight(t, g, o, n.partnerSeparation / 1.3);
                            else if (2 == g.isPartner) f = OrgChart.ui._linkRightToLeft(t, g, o, n.partnerSeparation / 1.3);
                            else {
                                var m = 1 == g.layout ? void 0 : p.minY - (p.minY - d.maxY) / 2;
                                f = OrgChart.ui._linkTopToBottom(t, g, o, s, m);
                            }
                            break;
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            if (1 == g.isPartner) f = OrgChart.ui._linkLeftToRight(t, g, o, n.partnerSeparation / 2);
                            else if (2 == g.isPartner) f = OrgChart.ui._linkRightToLeft(t, g, o, n.partnerSeparation / 2);
                            else {
                                m = 1 == g.layout ? void 0 : p.maxY - (p.maxY - d.minY) / 2;
                                f = OrgChart.ui._linkBottomToTop(t, g, o, s, m);
                            }
                            break;
                        case OrgChart.orientation.right:
                        case OrgChart.orientation.right_top:
                            if (1 == g.isPartner) f = OrgChart.ui._linkTopToBottom(t, g, o, n.partnerSeparation / 2);
                            else if (2 == g.isPartner) f = OrgChart.ui._linkBottomToTop(t, g, o, n.partnerSeparation / 2);
                            else {
                                m = 1 == g.layout ? void 0 : p.maxX - (p.maxX - d.minX) / 2;
                                f = OrgChart.ui._linkRightToLeft(t, g, o, s, m);
                            }
                            break;
                        case OrgChart.orientation.left:
                        case OrgChart.orientation.left_top:
                            if (1 == g.isPartner) f = OrgChart.ui._linkTopToBottom(t, g, o, n.partnerSeparation / 2);
                                ...
                                m = 1 == g.layout ? void 0 : p.minX - (p.minX - d.maxX) / 2;
                                f = OrgChart.ui._linkLeftToRight(t, g, o, s, m);
                            }
                    }
                (u = u.replaceAll("{xa}", f.xa).replaceAll("{ya}", f.ya).replaceAll("{xb}", f.xb).replaceAll("{yb}", f.yb).replaceAll("{xc}", f.xc).replaceAll("{yc}", f.yc).replaceAll("{xd}", f.xd).replaceAll("{yd}", f.yd)),
                    l.push(
                        OrgChart.linkOpenTag
                            .replace("{id}", t.id)
                            .replace("{class}", "link " + g.tags.join(" "))
                            .replace("{child-id}", g.id)
                    ),
                    l.push(u);
                var C = "";
                for (var y in e.config.linkBinding) {
                    var O = e.config.linkBinding[y],
                        v = e._get(g.id);
                    if (v) {
                        var x = v[O];
                        null != x && null != x && null != o[y] && (C += o[y].replace("{val}", x));
                    }
                }
                "" != C && ((C = OrgChart.linkFieldsOpenTag.replace("{x}", f.x).replace("{y}", f.y).replace("{rotate}", 0) + C + OrgChart.grCloseTag), l.push(C)), l.push(OrgChart.grCloseTag);
            }
            return l.join("");
        },
    ...
    if ("multiline" == s) {
        ...
        //u.setAttributeNS(null, "x", 140), u.setAttributeNS(null, "y", 50), u.setAttributeNS(null, "text-anchor", n), u.appendChild(C), d.appendChild(u);
        g = 1;
        var xx = 125;
        var yy = 65;
        var xxMinus = 125; var yyPlus = 65;
        for (var m = 1; m < p.length; m++) {
            ...
            if (p[m] != "") {
                ...
                //if (u.firstChild.data += " " + "*" + " " + p[m], u.getComputedTextLength() > l) u.firstChild.data = u.firstChild.data.slice(0, O), (u = document.createElementNS(h, "tspan")).setAttributeNS(null, "x", xxMinus), u.setAttributeNS(null, "y", yyPlus), u.setAttributeNS(null, "text-anchor", n), C = document.createTextNode("*" + " " + p[m]), u.appendChild(C), d.appendChild(u), g++
                //$("tspan").after("<br />");
                //xxMinus = xxMinus - 30;
                //yyPlus = xxMinus + 15;
                //$(".field_0").attr("y", "20");
        ...
        if ((this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
            ...
            !(function (t, i, e) {
                ...
                function n() {
                    ...
                    (o.bar.scrollLeft += t), o.bar.scrollLeft == o.pos ? (a = !1) : r(n);
                }
                t.addEventListener(
                    "wheel",
                    function (t) {
        ...
        if (this.config.mouseScrool == OrgChart.action.yScroll || this.config.mouseScrool == OrgChart.action.scroll) {
            ...
            !(function (t, i, e) {
                ...
                function n() {
                    ...
                    (o.bar.scrollTop += t), o.bar.scrollTop == o.pos ? (a = !1) : r(n);
                }
                t.addEventListener(
                    "wheel",
                    function (t) {
    ...
    (OrgChart.pdfPrevUI._handler = function (t, e, r) {
        ...
        for (var s = l.querySelector("svg"), h = t.element.querySelector("#bg-ppdf-content"), d = 0; d < a.length; d++) {
            ...
            a[d].footer && (f = a[d].footer),
                ...
                a[d].html
                    ? g.write(OrgChart._exportHtml(a[d].html + e.styles, i, a[d].innerSize.w, a[d].innerSize.h, p, f))
                    : (s.setAttribute("viewBox", a[d].vb), g.write(OrgChart._exportHtml(l.innerHTML + e.styles, i, a[d].innerSize.w, a[d].innerSize.h, p, f)));
        ...
        var O = t.element.querySelector("#bg-ppdf-content");
        OrgChart.anim(O, { opacity: 0 }, { opacity: 1 }, 300, OrgChart.anim.outSin);
    }),
        ...
        for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
            ...
            if (-1 != e.res.visibleNodeIds.indexOf(h.from) && -1 != e.res.visibleNodeIds.indexOf(h.to)) {
                ...
                switch (this.config.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        y <= O ? ((b = 1), (m.x = y + d.w / 10), (C.x = O - c.w / 10)) : ((b = -1), (m.x = y - d.w / 10), (C.x = O + c.w / 10)),
                            p == u ? ((b = 1), (m.y = p), (C.y = u)) : u < p ? ((m.y = p), (C.y = u + c.h)) : ((m.y = p + d.h), (C.y = u));
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        (m.x = y <= O ? ((b = -1), y + d.w / 10) : ((b = 1), y - d.w / 10)), (C.x = O + c.w / 10), p == u ? ((b = -1), (m.y = p + d.h), (C.y = u + c.h)) : u < p ? ((m.y = p), (C.y = u + c.h)) : ((m.y = p + d.h), (C.y = u));
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        (m.y = v <= x ? ((b = -1), v + d.h / 5) : ((b = 1), v - d.h / 5)), (C.y = x + c.h / 5), g == f ? ((b = -1), (m.x = g), (C.x = f)) : f < g ? ((m.x = g), (C.x = f + c.w)) : ((m.x = g + d.w), (C.x = f));
                        break;
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        (m.y = v <= x ? ((b = 1), v + d.h / 5) : ((b = -1), v - d.h / 5)), (C.y = x + c.h / 5), g == f ? ((b = 1), (m.x = g + d.w), (C.x = f + c.w)) : f < g ? ((m.x = g), (C.x = f + c.w)) : ((m.x = g + d.w), (C.x = f));
                }
                var w = I(m, C, b),
                    k = h.template;
                k || (k = "orange");
                ...
                l +=
                    '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", d.id).replace("{to}", c.id) +
                    _.link
    ...
    (OrgChart.prototype._slinks = function (S, I) {
        ...
        function t(t, e, r) {
            ...
            var s = OrgChart.t(t.templateName, t.min, L),
                h = l.levelSeparation;
            ((t.parent && t.parent.layout == OrgChart.mixed) || (t.parent && t.parent.layout == OrgChart.tree)) && (h = l.mixedHierarchyNodesSeparation);
            var d = { p: t.x + t.w / 2 + s.expandCollapseSize, q: t.y, r: t.x + t.w / 2 + s.expandCollapseSize, s: M.minY + h };
            if (t.level == e.level)
                switch (((a = e), l.orientation)) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        i.push([d.p, d.q]), i.push([d.p, d.q - h / 3]), (s = OrgChart.t(a.templateName, a.min, L)), i.push([a.x + a.w / 2 + s.expandCollapseSize, i[i.length - 1][1]]), i.push([i[i.length - 1][0], a.y]);
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        (d.q = t.y + t.h),
                            ...
                            (s = OrgChart.t(a.templateName, a.min, L)),
                ...
                switch (l.orientation) {
                    ...
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        (d.q = t.y + t.h), (d.s = M.maxY - h), i.push([d.p, d.q]), i.push([d.r, t.y + t.h + h / 3]);
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        (d.p = t.x), (d.q = t.y + t.h / 2 + s.expandCollapseSize), (d.r = M.minX - h), (d.s = t.y + t.h / 2 + s.expandCollapseSize), i.push([d.p, d.q]), i.push([t.x - h / 3, d.q]);
                        break;
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        (d.p = t.x + t.w), (d.q = t.y + t.h / 2 + s.expandCollapseSize), (d.r = M.maxX + h), (d.s = t.y + t.h / 2 + s.expandCollapseSize), i.push([d.p, d.q]), i.push([t.x + t.w + h / 3, d.q]);
                }
                for (var c = t; null == a;) {
                    var g = !1,
                        p = c.parent,
                ...
                switch (((s = OrgChart.t(a.templateName, a.min, L)), i.splice(i.length - 1, 1), l.orientation)) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
            ...
            switch ((s = OrgChart.slinkTemplates[y]).labelPosition) {
                case "start":
                    ...
                    break;
                case "middle":
                    var v = Math.ceil(i.length / 2);
                    O = (function (t, e) {
                        return { x: (t[0] + e[0]) / 2, y: (t[1] + e[1]) / 2 };
                    })(i[v], i[v - 1]);
                    break;
                case "end":
                    O = { x: i[i.length - 2][0], y: i[i.length - 2][1] };
            }
            r && (i = i.reverse()), (i[0] = "M" + i[0].join(","));
            for (var x = 1; x < i.length; x++) i[x] = "L" + i[x].join(",");
            var b = i.join(" ");
            if (((A += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", t.id).replace("{to}", e.id) + s.link.replaceAll("{d}", b)), E.label)) {
                var w = s.label.replace("{x}", O.x).replace("{y}", O.y).replace("{val}", E.label),
        ...
        for (var e = 0; e < this.config.slinks.length; e++) {
            ...
            if (-1 != I.res.visibleNodeIds.indexOf(E.from) && -1 != I.res.visibleNodeIds.indexOf(E.to)) {
