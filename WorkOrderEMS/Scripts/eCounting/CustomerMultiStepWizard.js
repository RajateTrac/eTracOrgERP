$(document).ready(function () {
    ...
    $(".next").click(function () {
        ...
        if ($("#msform").valid()) 
        {
            ...
            //Comment  next two and uncomment from line no 32 if solve next button issue customer wizard
            current_fs.hide();
            animating = false;
...
var displayConfirm = function () {
    var form = $("#msform");
    $('#divCustomerRecapDetails .form-control-static', form).each(function () {
        var input = $('[name="' + $(this).attr("data-display") + '"]', form);
        if (input.is(":radio")) {
            input = $('[name="' + $(this).attr("data-display") + '"]:checked', form);
        }
        if (input.is(":text") || input.is("textarea")) {
            $(this).html((input.val() == "") ? "N/A" : input.val());
            ...
            $(this).html(($('input[name="' + $(this).attr("data-display") + '"]').is(':checked')==true) ? "Yes" : "No");
        } 
