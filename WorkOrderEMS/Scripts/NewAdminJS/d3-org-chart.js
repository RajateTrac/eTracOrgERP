...
!(function (t, n) {
    ...
    function Nn(t) {
        ...
        var n = (t = t.rgb()).r / 255,
            ...
            u = o - i,
            c = (o + i) / 2;
        return u ? ((a = n === o ? (e - r) / u + 6 * (e < r) : e === o ? (r - n) / u + 2 : (n - e) / u + 4), (u /= c < 0.5 ? o + i : 2 - o - i), (a *= 60)) : (u = c > 0 && c < 1 ? 0 : a), new An(a, u, c, t.opacity);
    }
    function Tn(t, n, e, r) {
    ...
    function Un(t) {
        ...
        return (
            r === i && i === o ? (n = e = a) : ((n = Fn((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Cn)), (e = Fn((0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / zn))), new Bn(116 * a - 16, 500 * (n - a), 200 * (a - e), t.opacity)
        );
    }
    function On(t, n, e, r) {
    ...
    function Ne(t, n) {
        ...
        for (t += "", n += ""; (e = we.exec(t)) && (r = Me.exec(n));)
            (i = r.index) > o && ((i = n.slice(o, i)), u[a] ? (u[a] += i) : (u[++a] = i)), (e = e[0]) === (r = r[0]) ? (u[a] ? (u[a] += r) : (u[++a] = r)) : ((u[++a] = null), c.push({ i: a, x: me(e, r) })), (o = Me.lastIndex);
        return (
    ...
    var qe = De(
        ...
        Le = De(
            function (t) {
                return null == t
                    ? ze
                    : (Ce || (Ce = document.createElementNS("http://www.w3.org/2000/svg", "g")), Ce.setAttribute("transform", t), (t = Ce.transform.baseVal.consolidate()) ? Re((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : ze);
            },
            ", ",
            ")",
            ")"
                        ...
                        F.on(
                            ...
                            function () {
                                switch (t.event.keyCode) {
                                    ...
                                    case 32:
                                        x === Mi &&
                                            (t.event.altKey ? (w && ((f = h - P * w), (r = o + P * w)), M && ((d = p - z * M), (u = c + z * M)), (x = Ti)) : (w < 0 ? (f = h) : w > 0 && (r = o), M < 0 ? (d = p) : M > 0 && (u = c), (x = Ni)),
                                                B.attr("cursor", Pi[m]),
                                                I());
                                        break;
                                    default:
    ...
    function Bo(t) {
        ...
        return isNaN(t)
            ...
            "-" +
            Oo(t.getUTCDate(), 2) +
            (i ? "T" + Oo(n, 2) + ":" + Oo(e, 2) + ":" + Oo(r, 2) + "." + Oo(i, 3) + "Z" : r ? "T" + Oo(n, 2) + ":" + Oo(e, 2) + ":" + Oo(r, 2) + "Z" : e || n ? "T" + Oo(n, 2) + ":" + Oo(e, 2) + "Z" : "");
    }
    function Fo(t) {
        var n = new RegExp('["' + t + "\n\r]"),
            e = t.charCodeAt(0);
    ...
    (Ta.copy = function () {
        ...
        for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop());) for (var i = 0; i < 4; ++i) (n = r.source[i]) && (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = Na(n)));
        return e;
    }),
        (Ta.add = function (t) {
    ...
    function Tc(t, n) {
        ...
        if (rc) {
            ...
            var o,
                ...
                c = i[0] * uu * u,
                f = fu(a) > 180;
            f ^ (u * tc < c && c < u * t) ? (o = i[1] * uu) > Ju && (Ju = o) : f ^ (u * tc < (c = ((c + 360) % 360) - 180) && c < u * t) ? (o = -i[1] * uu) < Qu && (Qu = o) : (n < Qu && (Qu = n), n > Ju && (Ju = n)),
                f ? (t < tc ? Pc(Zu, t) > Pc(Zu, Ku) && (Ku = t) : Pc(t, Ku) > Pc(Zu, Ku) && (Zu = t)) : Ku >= Zu ? (t < Zu && (Zu = t), t > Ku && (Ku = t)) : t > tc ? Pc(Zu, t) > Pc(Zu, Ku) && (Ku = t) : Pc(t, Ku) > Pc(Zu, Ku) && (Zu = t);
                ...
                function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
                    ...
                    if (b > 4 * n && v--) {
                        var m = a + h,
                            ...
                            C = k - i,
                            P = _ * E - y * C;
                        ((P * P) / b > n || fu((y * E + _ * C) / b - 0.5) > 0.3 || a * h + u * d + c * p < Gs) && (e(r, i, o, a, u, c, S, k, T, (m /= M), (x /= M), w, v, g), g.point(S, k), e(S, k, T, m, x, w, f, s, l, h, d, p, v, g));
                    }
                }
                return function (n) {
                    var r,
    ...
    function kl(t, n) {
        ...
        for (null == n && (n = El); (e = f.pop());)
            if ((c && (e.value = +e.data.value), (i = n(e.data)) && (a = i.length))) for (e.children = new Array(a), o = a - 1; o >= 0; --o) f.push((r = e.children[o] = new zl(i[o]))), (r.parent = e), (r.depth = e.depth + 1);
        ...
        function w(t, n) {
            return function (e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < f;)
                    37 === t.charCodeAt(u) && (a.push(t.slice(c, u)), null != (i = xp[(r = t.charAt(++u))]) ? (r = t.charAt(++u)) : (i = "e" === r ? " " : "0"), (o = n[r]) && (r = o(e, i)), a.push(r), (c = u + 1));
                ...
                if ((!n || "Z" in o || (o.Z = 0), "p" in o && (o.H = (o.H % 12) + 12 * o.p), void 0 === o.m && (o.m = "q" in o ? o.q : 0), "V" in o)) {
                    ...
                    "w" in o || (o.w = 1),
                        "Z" in o
                            ...
                            : ((i = (r = gp(_p(o.y, 0, 1))).getDay()), (r = i > 4 || 0 === i ? kd.ceil(r) : kd(r)), (r = Nd.offset(r, 7 * (o.V - 1))), (o.y = r.getFullYear()), (o.m = r.getMonth()), (o.d = r.getDate() + ((o.w + 6) % 7)));
        ...
        (t.ribbon = function () {
            ...
            function a() {
                var a,
                    ...
                    g = r.apply(this, u) - Xi,
                    y = i.apply(this, u) - Xi;
                if ((o || (o = a = no()), o.moveTo(d, p), o.arc(0, 0, s, l, h), (l === g && h === y) || (o.quadraticCurveTo(0, 0, v * Ii(g), v * Hi(g)), o.arc(0, 0, v, g, y)), o.quadraticCurveTo(0, 0, d, p), o.closePath(), a))
