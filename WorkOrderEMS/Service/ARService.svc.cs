...
namespace WorkOrderEMS.Service
{
    ...
    public class ARService : IARService
    {
        ...
        public DataTable GetItemMasterDetails(long? ItemId, long? LocationId)
        {
            //string QueryString = "EXEC USP_GetItemMasterDetails '" + ItemId + "'";
            string QueryString = "EXEC USP_GetItemMasterDetails '" + ItemId + "','" + LocationId + "'";
            return DB.GetDTResponse(QueryString);
        ...
        public DataTable GetLocationWiseCostCode(Int64? LocationId)
        {
            string QueryString = "EXEC USP_Get_Location_Wise_CostCode'" + LocationId + "'";
            return DB.GetDTResponse(QueryString);
            //List<Tbl_Item_Master> ItemList = DataRowToObject.CreateListFromTable<Tbl_Item_Master>(dataTable);
            //return ItemList;
        }
        ...
        public List<WorkOrderEMS.Data.EntityModel.ApplicantSchecduleAvaliblity> GetScheduleEmployeeList(long Location,string EmployeeId)
        {
            string SQRY = "EXEC USP_GetScheduleEmployeeList N'" + Location + "','"+ EmployeeId + "'";
            DataTable DT = DB.GetDTResponse(SQRY);
            List<WorkOrderEMS.Data.EntityModel.ApplicantSchecduleAvaliblity> ItemList = DataRowToObject.CreateListFromTable<WorkOrderEMS.Data.EntityModel.ApplicantSchecduleAvaliblity>(DT);
            return ItemList;
        }
